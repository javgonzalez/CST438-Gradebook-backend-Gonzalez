...
public class JunitTestGradebook {
   ...
   /*
    * Used to test that an assignment was added
    */
   @Test
   public void addAssignment() throws Exception {
      ...
      AssignmentListDTO.AssignmentDTO newAssignment = new AssignmentListDTO.AssignmentDTO();
      newAssignment.courseId = TEST_COURSE_ID;
      newAssignment.assignmentName = assignmentName;
      newAssignment.dueDate= "2022-05-05";

      // then do an http post request for assignment
   ...
   /*
    * Used to test if an assignment name was updated
    */
   ...
   public void updateAssignmentName() throws Exception {
      ...
      String updatedName = "Updated Test Assignment";
   ...
   /*
    * Used to test if an assignment has been deleted
    */
   @Test
   public void deleteAssignment() throws Exception {
      ...
      //  http delete request to delete assignment 
      response = mvc
